...
%% Show results
figure(1);
subplot(2,3,1);imshow(target_image);title('YCbCr Cr');
subplot(2,3,2);imshow(target_image_eq);title('YCbCr Cr equalized');
subplot(2,3,3);imshow(target_image_filtered);title('YCbCr Cr filtered');
