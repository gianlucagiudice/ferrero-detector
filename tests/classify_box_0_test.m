...
%% FAR VEDER CHE HO BARATO
% Raffaello mask small close
choccolate_fraction = 1/6;
tsize = round(r * choccolate_size_percentage * choccolate_fraction);
se = strel('disk', tsize);
raffaello_small_close = imclose(raffaello, se);
...
tsize = round(r * choccolate_size_percentage * choccolate_fraction);
se = strel('disk', tsize);
raffaello_mask_filtered_closed = imclose(raffaello_mask_filtered, se);

% Close BIG
choccolate_fraction = 1.5;
tsize = round(r * choccolate_size_percentage * choccolate_fraction);
se = strel('square', tsize);
raffaello_mask_filtered_closed_big = imclose(raffaello_mask_filtered_closed, se);
...
tsize = round(r * choccolate_size_percentage * choccolate_fraction);
se = strel('square', tsize);
rondnoir_mask_filtered_closed_big = imclose(rondnoir_mask_filtered_closed, se);
...
subplot(5,4,9);
imshow(raffaello);
title("Raffaello mask");    
subplot(5,4,10);
imshow(raffaello_mask_filtered), axis image;
title("Raffaello mask medfilt2()");
subplot(5,4,11);
imshow(raffaello_mask_filtered_closed), axis image;
title("Raffaello filtered imclose()");
subplot(5,4,12);
imshow(raffaello_mask_filtered_closed_big), axis image;
title("Raffaello imclose() BIG");
%% Rondnoir
subplot(5,4,13);
...
%% Box classified
subplot(5,4,17);
imshow(rondnoir_mask_filtered_closed_big);
title("Rondnoir mask filtered imclose() BIG");
subplot(5,4,18);
